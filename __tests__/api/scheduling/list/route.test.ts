  ...
  it('should list all reservations in hydrated form - POST /scheduling/list/', async () => {
    ...
    expect(originalReservations).toEqual(Object.entries({
      ...
      1: {
        ...
        id: 2,
        localEndsAt: "2026-06-01T12:00:00Z",
        localStartsAt: "2026-06-01T11:00:00Z",
        resource: {
          capacity: 8,
          id: 1,
          kind: "room",
      ...
      2: {
        ...
        id: 3,
        localEndsAt: "2026-06-02T16:00:00Z",
        localStartsAt: "2026-06-02T14:00:00Z",
        resource: {
          capacity: 1,
          id: 2,
          kind: "gpu",
      ...
      3: {
        ...
        id: 4,
        localEndsAt: "2026-06-03T17:00:00Z",
        localStartsAt: "2026-06-03T08:00:00Z",
        resource: {
          capacity: 9,
          id: 3,
          kind: "vehicle",
      ...
      4: {
        ...
        id: 5,
        localEndsAt: "2026-06-04T14:00:00Z",
        localStartsAt: "2026-06-04T13:00:00Z",
        resource: {
          capacity: 12,
          id: 5,
          kind: "room",
