...
import { replaceReservation, getSingleReservation, noBodyErrorResponse, noPayloadErrorResponse, noTimezoneErrorResponse } from "../handlers";
...
export const POST = async (request: NextRequest) => {
  ...
  return replaceReservation(payload);
}